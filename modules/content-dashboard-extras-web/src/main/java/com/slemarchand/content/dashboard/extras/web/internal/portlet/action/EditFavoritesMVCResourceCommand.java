...
@Component(
	...
	property = {
		...
		"mvc.command.name=/content_dashboard_extras/edit_favorites"
	},
	service = MVCResourceCommand.class
)
public class EditFavoritesMVCResourceCommand
	...
	protected void doServeResource(
		...
		try {
			...
			String favorites = ParamUtil.getString(resourceRequest, "favorites", StringPool.BLANK);
			
			JSONArray jsonArray = JSONArrayUtil.deserializeJSONArray(favorites);
	
			PortletPreferences prefs = PortletPreferencesFactoryUtil.getPortletSetup(resourceRequest);
			
			prefs.setValue("com.slemarchand.content.dashboard.extras.favorites", jsonArray.toJSONString());
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EditFavoritesMVCResourceCommand.class);
